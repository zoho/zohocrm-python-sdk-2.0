...
from zcrmsdk.src.com.zoho.crm.api.record import Comment, Consent, Record, FileDetails, Participants, LineTax, \
    InventoryLineItems, RemindAt, Reminder, PricingDetails, RecurringActivity
...
class RelatedRecord(object):
    ...
    def get_related_records(module_api_name, record_id, related_list_api_name):
        ...
        # Call get_related_records method that takes record_id, ParameterMap instance and HeaderMap instance as parameter
    ...
    def update_related_records(module_api_name, record_id, related_list_api_name):
        ...
        record_2.set_id(3477061000010927068)
        ...
        # Call update_related_records method that takes record_id, BodyWrapper instance
    ...
    def delink_records(module_api_name, record_id, related_list_api_name, related_list_ids):
        ...
        # Call delink_records method that takes record_id and ParameterMap instance as parameter.
    ...
    def get_related_records_using_external_id(module_api_name, external_value, related_list_api_name):
        ...
        example
        module_api_name = "Products"
        external_value = "3409643000000798007"
        related_list_api_name = "Price_Books"
        """
        ...
        related_records_operations = RelatedRecordsOperations(related_list_api_name, module_api_name, x_external)
    ...
    def update_related_records_using_external_id(module_api_name, external_value, related_list_api_name):
        ...
        # Call update_related_records_using_external_id method that takes external_value, BodyWrapper instance
    ...
    @staticmethod
    def delete_related_records_using_external_id(module_api_name, external_value, related_list_api_name, related_list_ids):
        ...
        # Call delete_related_records_using_external_id method that takes external_value and ParameterMap instance as parameter.
    ...
    def get_related_record(module_api_name, record_id, related_list_api_name, related_list_id, destination_folder):
        ...
        response = related_records_operations.get_related_record(related_list_id, record_id, header_instance)
    ...
    def update_related_record(module_api_name, record_id, related_list_api_name, related_list_id):
        ...
        # Call update_related_record method that takes related_list_id, record_id and BodyWrapper instance as parameter.
    ...
    def delink_record(module_api_name, record_id, related_list_api_name, related_list_id):
        ...
        # Get instance of RelatedRecordsOperations Class that takes module_api_name and module_api_name as parameter
        related_records_operations = RelatedRecordsOperations(related_list_api_name, module_api_name)

        # Call delink_record method that takes related_list_id and record_id as parameter.
        response = related_records_operations.delink_record(related_list_id, record_id)
    ...
    @staticmethod
    def get_related_record_using_external_id(module_api_name, external_value, related_list_api_name, external_field_value, destination_folder):
        ...
        external_value = "3409643000000798007"
        related_list_api_name = "Price_Books"
        external_field_value = "3409643000002414001"
        destination_folder = "/Users/user_name/Desktop"
        """

        x_external = "Leads.External,Products.Products_External"

        # Get instance of RelatedRecordsOperations Class that takes moduleAPIName, relatedListAPIName and x_external as parameter
        related_records_operations = RelatedRecordsOperations(related_list_api_name, module_api_name, x_external)
        ...
        response = related_records_operations.get_related_record_using_external_id(external_field_value, external_value, header_instance)
    ...
    @staticmethod
    def update_related_record_using_external_id(module_api_name, external_value, related_list_api_name, external_field_value):
    ...
    @staticmethod
    def delete_related_record_using_external_id(module_api_name, external_value, related_list_api_name, external_field_value):
        ...
        response = related_records_operations.delete_related_record_using_external_id(external_field_value, external_value)
